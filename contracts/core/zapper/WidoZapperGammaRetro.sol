...
contract WidoZapperGammaRetro is WidoZapper_ERC20_ERC20 {
    ...
    function calcMinToAmountForZapOut(
        ...
        IUniswapV3Pool pool = IUniswapV3Pool(Hypervisor(address(pair)).pool());
    ...
    function _amountsForShares(
        ...
        IUniswapV3Pool pool = IUniswapV3Pool(hyper.pool());
    ...
    function _deposit(Zap memory zap) internal returns (uint256 liquidity) {
