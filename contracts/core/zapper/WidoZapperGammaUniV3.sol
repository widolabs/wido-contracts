...
interface ISwapRouterUniV3 is IUniswapV3SwapCallback {
    ...
    function exactInputSingle(ISwapRouterUniV3.ExactInputSingleParams calldata params) external payable returns (uint256 amountOut);
}

/// @title Gamma pools Zapper
/// @notice Add or remove liquidity from Gamma pools using just one of the pool tokens
contract WidoZapperGammaUniV3 is WidoZapperGammaAlgebra {
    ...
    returns (uint256 amountOut) {
        ...
        amountOut = ISwapRouterUniV3(router).exactInputSingle(
