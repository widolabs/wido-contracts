...
contract WidoZapperUniswapV2_2 {
    ...
    function zapIn(
        ...
        console2.log(IERC20(fromToken).balanceOf(address(this)));
    ...
    function _swapAndAddLiquidity(
        ...
        console2.log(fullInvestment);
        console2.log(swappedAmounts[0]);
        console2.log(swappedAmounts[1]);
        console2.log(fullInvestment.sub(swappedAmounts[0]));
