...
export class CUSDCv3Ext__factory {
  static readonly abi = _abi;
  static createInterface(): CUSDCv3ExtInterface {
    return new utils.Interface(_abi) as CUSDCv3ExtInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CUSDCv3Ext {
    return new Contract(address, _abi, signerOrProvider) as CUSDCv3Ext;
  }
}
