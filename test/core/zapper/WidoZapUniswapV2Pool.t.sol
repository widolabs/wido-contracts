...
import "../../../contracts/core/zapper/WidoZapUniswapV2Pool.sol";

contract WidoZapUniswapV2PoolTest is MainnetForkTest {
    using SafeMath for uint256;

    WidoZapUniswapV2Pool zapper;
    ...
    function setUp() public {
        ...
        zapper = new WidoZapUniswapV2Pool();
