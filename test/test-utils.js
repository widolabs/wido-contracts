...
async function _getUSDCContract(signer) {
...
async function prepForUSDC(walletAddress, amount) {
    ...
    const usdcContract = await _getUSDCContract(signer);
...
async function approveWidoForUSDC(signer, widoAddress) {
    ...
    // console.log(await usdcContract.allowance(signer.address, widoAddress));
}
...
async function approveWidoForDai(signer, widoAddress) {
    ...
    // console.log(await daiContract.allowance(signer.address, widoAddress));
}
...
module.exports = { prepForUSDC, prepForDai, approveWidoForUSDC, approveWidoForDai, buildAndSignDepositRequest };